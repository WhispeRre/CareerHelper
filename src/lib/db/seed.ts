    ...
    },
    {
      ...
      content: {
        items: [
          {
            id: crypto.randomUUID(),
            name: 'careerhelper 简历助手',
            url: 'https://github.com/example/careerhelper',
            startDate: '2024-10',
            endDate: '2025-02',
          ...
          },
          {
            ...
            startDate: '2023-03',
            endDate: '',
            description: '面向 React 生态的高质量 UI 组件库，注重无障碍访问和主题定制。',
            technologies: ['React', 'TypeScript', 'Storybook', 'Radix UI'],
            highlights: [
              'GitHub 2.5k+ Stars，npm 周下载量 8k+',
              '完善的 A11y 支持，符合 WCAG 2.1 AA 标准',
            ],
          },
        ],
      },
