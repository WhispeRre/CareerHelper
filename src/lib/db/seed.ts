...
async function seed() {
      ...
      content: {
        categories: [
          ...
          },
          {
            id: crypto.randomUUID(),
            name: 'AI',
            skills: ['Vercel AI SDK', 'Prompt Engineering', 'OpenAI API', 'RAG Basics'],
          },
          {
            id: crypto.randomUUID(),
            name: 'Backend',
            skills: ['Node.js', 'PostgreSQL', 'SQLite', 'Docker'],
          },
          {
            id: crypto.randomUUID(),
            name: 'Product',
            skills: ['UX Prototyping', 'Analytics', 'A/B Testing'],
          },
        ],
      },
    },
  ...
  console.log('Seed complete! Demo resume created for user "Jacky"');
  process.exit(0);
}
